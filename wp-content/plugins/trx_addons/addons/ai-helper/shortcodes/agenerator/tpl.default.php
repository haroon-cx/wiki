						...
						?><div class="sc_agenerator_form_fields_left"><?php
							...
							?><div class="sc_agenerator_form_field sc_agenerator_form_field_prompt" data-actions="tts">
								<div class="sc_agenerator_form_field_inner">
									<label for="sc_agenerator_form_field_prompt_text<?php echo esc_attr( $id_suffix ); ?>"><?php esc_html_e( 'Text', 'trx_addons' ); ?></label>
									<input type="text"
										id="sc_agenerator_form_field_prompt_text<?php echo esc_attr( $id_suffix ); ?>"
								...
								<div class="sc_agenerator_form_field_inner">
									...
									?>">
										...
										if ( ! empty( $args['show_settings'] ) && (int) $args['show_settings'] > 0 ) {
											...
											?><a href="#" class="sc_agenerator_form_settings_button <?php echo esc_attr( $settings_icon ) ?>"><?php

				...
				?>>
					...
					?>">
						<div class="sc_vgenerator_form_field_inner">
							<input type="text"
								id="sc_vgenerator_form_field_prompt_text<?php echo esc_attr( $id_suffix ); ?>"
						...
						if ( ! empty( $args['show_settings'] ) && (int) $args['show_settings'] > 0 ) {
							...
							?>
							<a href="#" class="sc_vgenerator_form_settings_button <?php echo esc_attr( $settings_icon ) ?>"><?php

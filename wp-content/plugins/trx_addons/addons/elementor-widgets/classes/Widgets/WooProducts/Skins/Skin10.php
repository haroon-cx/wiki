...
class Skin10 extends BaseSkin {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn svg' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .trx-addons-woo-products.trx-addons-woo-products-skin-grid-10 .trx-addons-woo-products-product-wrapper .trx-addons-woo-products-qv-btn:hover svg' => 'fill: {{VALUE}}',
				),
			)
		);
	...
	public function render_product_structure_cta() {
        ...
        if ( $product->is_in_stock() ) {
            ...
            $cta_string = __( 'View Product', 'trx_addons' );
        }
